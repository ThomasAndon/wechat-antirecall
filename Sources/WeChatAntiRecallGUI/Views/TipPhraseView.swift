        ...
        Card {
            VStack(alignment: .leading, spacing: 10) {
                ...
                HStack(spacing: 8) {
                    ...
                    placeholderChip("{content}", "消息内容", enabled: true)
                }
    ...
    private var previewCard: some View {
        Card {
            VStack(alignment: .leading, spacing: 8) {
                ...
                Text("说明：构建号 269340、269341、269574、269575、269576、269577、269578、269579、269619、269624、269628、270090、270100 会显示本次启动后缓存的文字或媒体类型；其他构建、冷缓存、已淘汰或 ID 缺失的消息会省略。")
